...
async function getYoutubeList(searchQueries){
    ...
    const response = await fetch(`https://www.googleapis.com/youtube/v3/search?part=snippet&q=${formattedQueries}&type=video&videoEmbeddable=true&order=relevance&maxResults=25&safeSearch=strict&key=${apiKey}`)
